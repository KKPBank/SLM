...
{
    public partial class SLM_SCR_023 : System.Web.UI.Page
    {
        private static readonly ILog _log = LogManager.GetLogger(typeof(SLM_SCR_023));

        protected override void OnInit(EventArgs e)
        {
            base.OnInit(e);
            ((Label)Page.Master.FindControl("lblTopic")).Text = "ค้นหาค่าการจ่ายงาน";
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ScreenPrivilegeData priData = RoleBiz.GetScreenPrivilege(HttpContext.Current.User.Identity.Name, "SLM_SCR_023");
...
//            cmbProductSearch.DataSource = ProductBiz.GetProductList();
            ...
            cmbStaffTypeSearch.DataSource = StaffBiz.GetStaffTypeList();
...
//            cmbProductPopup.DataSource = ProductBiz.GetProductList();
            ...
            cmbStaffTypePopup.DataSource = StaffBiz.GetStaffTypeList();
        ...
        protected void PageSearchChange(object sender, EventArgs e)
        {
            try
            {
                ...
                DoSearchSystemAssign(pageControl.SelectedPageIndex);
            }
            catch (Exception ex)
            {
                string message = ex.InnerException != null ? ex.InnerException.Message : ex.Message;
