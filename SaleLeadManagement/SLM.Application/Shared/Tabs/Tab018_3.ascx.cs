...
{
    public partial class Tab018_3 : System.Web.UI.UserControl
    {
        private static readonly ILog _log = LogManager.GetLogger(typeof(Tab018_3));
        ...
        public SearchSRResponseItem[] GetData(int selectedPageIndex, int pageSize)
        {
            ...
            var searchSrResponse = CSMService.GetSrOwnerDataTab18_3(employeeCode, startPageIndex, pageSize);
        ...
        protected void PageSearchChange(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                lblErrorMessage.Text = "ไม่สามารถเชื่อมต่อระบบ CSM";
                //AppUtil.ClientAlert(Page, "ไม่สามารถเชื่อมต่อระบบ CSM");
            }
        }
