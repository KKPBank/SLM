<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TabFollowUp.ascx.cs" Inherits="SLM.Application.Shared.Obt.TabFollowUp" %>
...
<script type="text/javascript">
    ...
    function CheckAllWorkFlagTabFollowup() {
        var flag = document.getElementById('<%=cbWorkFlagAll_Followup.ClientID%>').checked;
        document.getElementById('<%=cbWaitCreditForm_Followup.ClientID%>').checked = flag;
        document.getElementById('<%=cbWait50Tawi_Followup.ClientID%>').checked = flag;
        document.getElementById('<%=cbWaitDriverLicense_Followup.ClientID%>').checked = flag;
        document.getElementById('<%=cbPolicyNo_Followup.ClientID%>').checked = flag;
        document.getElementById('<%=cbAct_Followup.ClientID%>').checked = flag;
        document.getElementById('<%=cbStopClaim_Followup.ClientID%>').checked = flag;
        document.getElementById('<%=cbStopClaim_Cancel_Followup.ClientID%>').checked = flag;
    }
    function CheckWorkFlagItemTabFollowup() {
        if (document.getElementById('<%=cbWaitCreditForm_Followup.ClientID%>').checked
            && document.getElementById('<%=cbWait50Tawi_Followup.ClientID%>').checked
            && document.getElementById('<%=cbWaitDriverLicense_Followup.ClientID%>').checked
            && document.getElementById('<%=cbPolicyNo_Followup.ClientID%>').checked
            && document.getElementById('<%=cbAct_Followup.ClientID%>').checked
            && document.getElementById('<%=cbStopClaim_Followup.ClientID%>').checked
            && document.getElementById('<%=cbStopClaim_Cancel_Followup.ClientID%>').checked)
            document.getElementById('<%=cbWorkFlagAll_Followup.ClientID%>').checked = true;
        else {
            document.getElementById('<%=cbWorkFlagAll_Followup.ClientID%>').checked = false;
        }
    }
</script>
        ...
        <asp:Panel ID="pnAdvanceSearch" runat="server" style="display:none;" >
            <table cellpadding="2" cellspacing="0" border="0">
                ...
                <%--<tr class="Hidden">
                    ...
                    <td class="ColInput">
                        <asp:DropDownList ID="cmbOwnerBranchSearch" runat="server" Width="203px" Enabled="false" 
                    ...
                    <td>
                        <asp:DropDownList ID="cmbOwnerLeadSearch" runat="server" Width="203px" Enabled="false" CssClass="Dropdownlist"></asp:DropDownList>
                    </td>
                </tr>
                <tr class="Hidden">
                    <td class="ColInfo">
                    ...
                    <td class="ColInput">
                        <asp:DropDownList ID="cmbDelegateBranchSearch" runat="server" Width="203px" Enabled="false" 
                            CssClass="Dropdownlist" AutoPostBack="true"
                    ...
                    <td>
                        <asp:DropDownList ID="cmbDelegateLeadSearch" runat="server" Width="203px" Enabled="false" CssClass="Dropdownlist"></asp:DropDownList>
                    </td>
                </tr>--%>
                <tr>
                    <td class="ColInfo">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        &nbsp;<asp:CheckBox ID="cbWorkFlagAll_Followup" runat="server" Text="ทั้งหมด" onchange="CheckAllWorkFlagTabFollowup()" />
                    </td>
                </tr>
                <tr>
                    <td class="ColInfo">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr style="height:32px;">
                                <td style="width:170px;">
                                    &nbsp;<asp:CheckBox id="cbWaitCreditForm_Followup" runat="server" Text="รอฟอร์มตัดบัตรเครดิต" onchange="CheckWorkFlagItemTabFollowup()" />
                                </td>
                                <td style="width:170px;">
                                    <asp:CheckBox id="cbWait50Tawi_Followup" runat="server" Text="รอฟอร์ม 50 ทวิ" onchange="CheckWorkFlagItemTabFollowup()" />
                                </td>
                                <td style="width:170px;">
                                    <asp:CheckBox id="cbWaitDriverLicense_Followup" runat="server" Text="รอสำเนาใบขับขี่" onchange="CheckWorkFlagItemTabFollowup()" />
                                </td>
                                <td style="width:170px;">
                                    &nbsp;<asp:CheckBox id="cbPolicyNo_Followup" runat="server" Text="ลูกค้าติดตามเลขกรมธรรม์" onchange="CheckWorkFlagItemTabFollowup()" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    &nbsp;<asp:CheckBox id="cbAct_Followup" runat="server" Text="ลูกค้าติดตามเลข พรบ." onchange="CheckWorkFlagItemTabFollowup()" />
                                </td>
                                <td>
                                    <asp:CheckBox id="cbStopClaim_Followup" runat="server" Text="ระงับเคลม" onchange="CheckWorkFlagItemTabFollowup()" />
                                </td>
                                <td>
                                    <asp:CheckBox id="cbStopClaim_Cancel_Followup" runat="server" Text="ยกเลิกระงับเคลม" onchange="CheckWorkFlagItemTabFollowup()" />
                                </td>
                                <td>
                                </td>
                            </tr>
