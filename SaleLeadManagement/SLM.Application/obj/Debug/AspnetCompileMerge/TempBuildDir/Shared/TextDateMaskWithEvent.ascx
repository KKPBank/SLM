<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TextDateMaskWithEvent.ascx.cs" Inherits="SLM.Application.Shared.TextDateMaskWithEvent" %>

<style type="text/css"> .ajax__calendar { z-index:500000 !important; position:relative; }</style>

<asp:TextBox ID="txtDate" runat="server" Width="100px" CssClass="Textbox" AutoPostBack="true" onchange="DisplayProcessing();" OnTextChanged="txtDate_OnTextChanged"  ></asp:TextBox>
