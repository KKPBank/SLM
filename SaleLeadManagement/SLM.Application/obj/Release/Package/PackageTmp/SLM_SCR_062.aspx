<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SaleLead.Master" AutoEventWireup="true" CodeBehind="SLM_SCR_062.aspx.cs" Inherits="SLM.Application.SLM_SCR_062" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <ContentTemplate>
            <table cellpadding="2" cellspacing="0" border="0">
                <tr>
                    ...
                    <td class="ColInput">
                        <asp:DropDownList ID="cmbSRole" runat="server" CssClass="Textbox" Width="200px" ></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td class="ColInfo">
                    ...
                    <td class="ColInput">
                        <asp:CheckBox runat="server" ID="chkSPolicy" Text="ประกันภัยรถยนต์" Checked="true" /> <asp:CheckBox runat="server" ID="chkSAct" Text="พรบ." Checked="true" />
                    </td>
                </tr>
                <tr>
                    <td class="ColInfo">
    ...
    <asp:UpdatePanel ID="upResult" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Button ID="btnAddTeam" runat="server" Text="เพิ่มข้อมูลส่วนลด" Width="130px" 
            ...
            <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False" Width="1230px"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:ImageButton ID="imbAction" runat="server" ImageUrl="~/Images/edit.gif" CommandArgument='<%# Eval("slm_Discount_Id") %>' ToolTip="แก้ไขข้อมูลทีม Telesales" OnClick="imbAction_Click" OnClientClick="DisplayProcessing()" />
                        </ItemTemplate>
                        <ItemStyle Width="30px" HorizontalAlign="Center" VerticalAlign="Top" />
                        <HeaderStyle Width="30px" HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:BoundField DataField="slm_StaffTypeDesc" HeaderText="Role" HtmlEncode="false"  >
                        <HeaderStyle Width="200px" HorizontalAlign="Center"/>
                        <ItemStyle Width="200px" HorizontalAlign="Left" VerticalAlign="Top" />
                    </asp:BoundField>
                    <asp:BoundField DataField="InsuranceType" HeaderText="ผลตอบแทนธนาคาร" HtmlEncode="false"  >
                    ...
                    <asp:TemplateField HeaderText="ส่วนลด (%)">
                        ...
                        <ItemTemplate>
                            <%# Eval("slm_DiscountPercent") %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="ส่วนลด (บาท)" >
                        <HeaderStyle Width="100px" HorizontalAlign="Center"/>
                        <ItemStyle Width="100px" HorizontalAlign="Center" VerticalAlign="Top" />
                        <ItemTemplate>
                            <%# Eval("slm_DiscountBath","{0:#,##0.00}") %>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<asp:UpdatePanel runat="server" ID="updModalMain">
    ...
    <asp:Panel runat="server" ID="pnlDetail" CssClass="modalPopupPromotion" style="height: 280px; padding: 10px; display:none;">
    <asp:UpdatePanel runat="server" ID="updModal" UpdateMode="Conditional">
        ...
        <table style="width:100%;"  >
            <tr>
                <td colspan="2">
                    <div class="box-header">ข้อมูลส่วนลด</div>
                </td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                <td class="ColInfo">Role <span class="require">*</span></td>
                <td><asp:DropDownList runat="server" ID="cmbDRole" CssClass="Textbox" Width="250px"></asp:DropDownList></td>
            </tr>
            <tr>
                <td class="ColInfo">ผลตอบแทนธนาคาร <span class="require">*</span></td>
                <td>
                    <asp:RadioButtonList runat="server" ID="rdoInsuranceType" RepeatDirection="Horizontal">
                        <asp:ListItem Value="204">ประกันภัยรถยนต์</asp:ListItem>
                        <asp:ListItem Value="205">พรบ.</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr style="border:1px solid #666;">
                <td class="ColInfo">
                    <asp:RadioButtonList runat="server" ID="rdoDiscount" OnSelectedIndexChanged="rdoDiscount_SelectedIndexChanged" AutoPostBack="true">
                        <asp:ListItem Value="1">ส่วนลด (%)</asp:ListItem>
                        <asp:ListItem Value="2">ส่วนลด (บาท)</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
                <td>
                    <asp:TextBox runat="server" ID="txtDDiscountValue" CssClass="Textbox" Width="250px" MaxLength="18"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="ColInfo"></td>
