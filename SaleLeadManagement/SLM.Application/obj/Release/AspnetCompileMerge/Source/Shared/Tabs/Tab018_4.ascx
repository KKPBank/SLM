<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tab018_4.ascx.cs" Inherits="SLM.Application.Shared.Tabs.Tab018_4" %>
...
<asp:UpdatePanel ID="upResult" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlResult" runat="server" ScrollBars="Auto" Width="1210px" BorderStyle="Solid" BorderWidth="1px">
            ...
            <asp:GridView ID="gvDelegate" runat="server" AutoGenerateColumns="False" DataKeyNames="SrNo"
